...
export function activate(context: vscode.ExtensionContext) {
    ...
    // Register commands
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-debugger.askQuestion', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-debugger.openPanel', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('ai-debugger.open', () => {
            // Focus the webview panel
            vscode.commands.executeCommand('ai-debugger-view.focus');
        })
    );
...
class AIDebuggerViewProvider implements vscode.WebviewViewProvider {
    ...
    public sendMessageFromCommand(message: string, mode: 'debugger' | 'tutor') {
        if (this._view) {
