...
<body>
    ...
    <script>
        ...
        console.log('Extension webview loaded successfully');
        
        // Test button clicks
        console.log('Run Debugger Button:', runDebuggerBtn);
        ...
        runDebugole.log('Run Debugger button clicked');
            ...
            console.log('Sending message via vscode.postMessage')ageInput.value.trim();
            console.log('sendMessage called with:', message);
            if (!message) return;
            
            console.log('Sending message with mode:', currentMode);
            vscode.postMessage({
                type: 'sendMessage',
                message: message,
                mode: currentMode
