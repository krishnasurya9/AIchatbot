...
FAST_SYSTEM_PROMPT = (
    "You are a professional Coding Assistant. Give concise, direct answers. "
    "Review the 'Relevant Context' if provided. "
...
async def get_chat_response(session_id: str, user_message: str, use_rag: bool = True, mode: str = "deep") -> dict:
    """
    mode: "fast" for quick responses, "deep" for comprehensive answers
    """
    ...
    try:
        ...
        system_prompt = FAST_SYSTEM_PROMPT if mode.lower() == "fast" else DEEP_SYSTEM_PROMPT
